...
<li class="nav-item"><a class="nav-link active" href="/searchByText">SEARCH BY TEXT</a></li>
...
<div class="container">
<div>
Please enter the Text you want to search
</div>
<div><form class="form-group" method="POST">
	<input type="text" name="productText" placeholder="search"/>
	<input type="submit" />
</form></div>
</div>
